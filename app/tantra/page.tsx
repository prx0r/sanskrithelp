...
const SECTIONS = [
  ...
  },
  {
    ...
    subtitle: "Standalone meditation timer & breathing visualizer",
    desc: "Multi-ring breath visualizer, focus mode, and meditation timer with Layayoga-specific techniques.",
    icon: BookMarked,
    external: true,
  },
];
