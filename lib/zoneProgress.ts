...
> = {
  ...
  gradation: { label: "Guṇa / Vṛddhi", prerequisites: ["phonetics"], order: 3, level_count: 5 },
  sandhi: { label: "Sandhi", prerequisites: ["phonetics", "gradation"], order: 4, level_count: 6 },
  roots: { label: "Dhātus", prerequisites: ["phonetics", "gradation"], order: 5, level_count: 7 },
  words: { label: "Words", prerequisites: [], order: 6, level_count: 5 },
  suffixes: { label: "Suffixes", prerequisites: ["roots"], order: 7, level_count: 5 },
  karakas: { label: "Kārakas", prerequisites: ["words"], order: 8, level_count: 6 },
  verbs: { label: "Verbs", prerequisites: ["roots"], order: 9, level_count: 7 },
  compounds: { label: "Compounds", prerequisites: ["sandhi", "karakas"], order: 10, level_count: 7 },
